...
import { Lesson001, Lesson002, Lesson003, Lesson004, Lesson005, Lesson006, Lesson007, Lesson008, Lesson009, TypesOfFood, 
  ...
  Lesson021, Lesson022, Lesson023, Lesson024, Lesson025, Lesson026, Lesson027, Lesson028, Landing } from "./components";
import './App.css';
    ...
    <div className="App">
      ...
      <Router>
        ...
        <Route path="/" exact component={() => <Landing />} />
          ...
          <Route path="/Lesson-027" exact component={() => <Lesson027 />} />
          <Route path="/Lesson-028" exact component={() => <Lesson028 />} />
